...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__demo_stories_source_json__ = __webpack_require__("../../../../../src/demo/demo-stories-source.json");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__demo_stories_source_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__demo_stories_source_json__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DemoComponent = (function () {
    function DemoComponent(cloukitStoryService) {
        this.cloukitStoryService = cloukitStoryService;
        //
        // REGISTER STORY SOURCES
        //
        var keys = Object.keys(__WEBPACK_IMPORTED_MODULE_2__demo_stories_source_json___default.a);
        for (var i = 0; i < keys.length; i++) {
            this.cloukitStoryService.addSource(keys[i], __WEBPACK_IMPORTED_MODULE_2__demo_stories_source_json___default.a[keys[i]]);
        }
    }
...
DemoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__components_story_service__["a" /* CloukitStoryService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__components_story_service__["a" /* CloukitStoryService */]) === "function" && _a || Object])
], DemoComponent);
